...
__webpack_require__(/*! ./block */ "./resources/js/block.js");

__webpack_require__(/*! ./gallery */ "./resources/js/gallery.js");

__webpack_require__(/*! ./blockinput */ "./resources/js/blockinput.js");
...
/***/ "./resources/js/blockinput.js":
/*!************************************!*\
  !*** ./resources/js/blockinput.js ***!
  \************************************/
/***/ (() => {

$(document).on("input", ".inputblocked", function () {
...
function refresh(tabs) {
  tabs.find('.tab').not('.active').css({
    "display": "none"
  });
  tabs.find('.tab.active').css({
    "display": "block"
  });
